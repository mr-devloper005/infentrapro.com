...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#1f2933',
  '--slot4-panel-bg': '#f4f8fd',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#4b5563',
  '--slot4-soft-muted-text': '#7a8491',
  '--slot4-accent': '#2f8fed',
  '--slot4-accent-fill': '#2f8fed',
  '--slot4-accent-soft': '#e6f2ff',
  '--slot4-dark-bg': '#202020',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#eaf2fb',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f7fbff',
  '--slot4-lavender': '#2f8fed',
  '--slot4-gray': '#edf1f5',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #f7fbff 52%, #eef6ff 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  button: {
    primary: `inline-flex items-center justify-center gap-2 rounded-full bg-[var(--slot4-dark-bg)] px-7 py-3.5 text-xs font-black uppercase tracking-[0.12em] text-white transition hover:bg-[var(--slot4-accent-fill)]`,
    secondary: `inline-flex items-center justify-center gap-2 rounded-full border border-black/30 bg-transparent px-7 py-3.5 text-xs font-black uppercase tracking-[0.12em] text-black transition hover:bg-black hover:text-white`,
