  ...
  return (
    <EditableSiteShell>
      <main className="bg-white text-[#111]">
        <section className="border-b border-black bg-[#202020] text-white">
          <div className="mx-auto max-w-[980px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
        ...
        <section className="mx-auto grid max-w-[980px] border-x border-black bg-white lg:grid-cols-[1.25fr_0.75fr]">
          ...
          <aside className="grid bg-[#f7fbff]">
        ...
        <section className="border-y border-black bg-[#202020] text-white">
          <div className="mx-auto flex max-w-[980px] flex-col gap-6 px-4 py-12 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
