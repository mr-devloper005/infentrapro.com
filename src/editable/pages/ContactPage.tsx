  ...
  return (
    <EditableSiteShell>
      <main className="bg-white text-[#111]">
        ...
        <section className="mx-auto grid max-w-[980px] border-x border-black bg-white lg:grid-cols-[0.78fr_1.22fr]">
          <aside className="border-b border-black bg-[#202020] text-white lg:border-b-0 lg:border-r">
