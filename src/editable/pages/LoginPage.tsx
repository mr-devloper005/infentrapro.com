  ...
  return (
    <EditableSiteShell>
      <main className="bg-white text-[#111]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[980px] border-x border-black bg-white lg:grid-cols-[1fr_1fr]">
          <div className="flex flex-col justify-center border-b border-black bg-[#202020] p-8 text-white sm:p-12 lg:border-b-0 lg:border-r lg:p-16">
